<div class="l-wellness sticky sticky--full-height sticky--under-previous sticky--under-next is-hidden--md-down" id="wellness" data-plugin="reveal">
    ...
    <div class="l-wellness__webgl ui-background ui-dark"
        ...
        <div class="l-wellness__webgl-caption pt-3">
            <h1 class="h1 pt-2 col col--md-6 offset--md-2 mb-1 leading-trim" data-reveal="text">FROM THE CMD’S DESK</h1>
            <p class="col pt-2  col--md-5 offset--md-2 mb-1 text-justify" data-reveal="text">
                I founded BST with a simple dream — to build homes that help people live better, healthier and happier lives. We embrace innovation, technology and AI, but never lose the human touch. I want every BST home to create lasting value and prosperity, and every relationship to become a genuine partnership built on trust. That, to me, is the real measure of our success.
            </p>
...
<div class="l-wellness sticky sticky--full-height sticky--under-previous sticky--under-next is-hidden--lg-up ui-dark ui-background" id="wellness-mobile">
    <div class="sticky__layer sticky__layer--sticky" data-scroll data-scroll-sticky
    ...
    <div class="l-wellness__webgl ui-background ui-dark">
        ...
        <div class="l-wellness__webgl-caption px-layout pt-3">
            ...
            <div class="col l-wellness__webgl-title text-right">
                <p class="g1 leading-trim"> Wellness </p>
                <p class="text-c1 leading-trim mt-1"> Essence of Self-Care </p>
            </div>
        </div>
...
<div class="l-wellness__slider-container is-hidden--lg-up ui-dark ui-background">
    ...
    <div class="l-wellness__slider__images p-relative mx-layout js-wellness-content-animation-controller" data-plugin="mobileScrollable">
