...
<head>
    ...
    <link rel="stylesheet" href="assets/stylesheets/privacy-policy.css">
    <script>
...
<body data-barba="wrapper">
    ...
    <div class="page-content-wrapper ui-light-background" data-barba="container" data-barba-namespace="page"
        ...
        <div class="page-content-wrapper__inner js-page-content-wrapper">
            ...
            <div class="page-content js-page-content">
                <main id="top">
                    <section class="section ui-light privacy-policy px-layout" data-scroll-section
                        data-themed-class="ui-light">
                        <div class="pt-3 mb-2">
                            <h1 class="h0 leading-trim">
                                <span class="is-hidden--xs">
                                    Privacy policy
                                </span>
                                <span class="is-hidden--sm-up" aria-hidden="true">
                                    Privacy<br>
                                    Policy
                                </span>
                            </h1>
                        ...
                        <hr>
                        <div class="row">
                            <div class="col col--xs-4 col--md-12 offset--md-5 pb-4 pb-2:md">
                                <div class="text text--policy">
                                    <p>1. Key Terms and Definitions<br />
                                        For the purposes of this Personal Data Processing Policy
                                        (the "Policy"), the following terms, definitions, and
                                        abbreviations are used:<br />
                                        Automated processing of personal data - processing
                                        of personal data using computing technology.<br />
                                        Biometric personal data - information describing
                                        an individual's physiological or biological characteristics that
                                        allows for their identification and is used to verify
                                        the identity of the personal data subject.<br />
                                        Blocking of personal data - temporary suspension
                                        of personal data processing (except when processing is required
                                        to clarify personal data).<br />
                                        Personal data legislation - applicable data protection laws and
                                        regulations governing the conditions, procedures, and security measures
                                        for processing and ensuring the confidentiality of personal
                                        data.<br />
                                        Confidentiality of personal data - the obligation
                                        of the Organization (its personnel) and other authorized individuals
                                        to refrain from disclosing or disseminating personal data
                                        to third parties without the consent of the data
                                        subject, unless otherwise required by applicable law.<br />
                                        Tangible medium for personal data - any physical object used
                                        for storing or recording personal data in electronic or written form
                                        (including paper documents and machine-readable media).<br />
                                        Non-automated processing of personal data - pers1. Key Terms and
                                        Definitions<br />
                                        For the purposes of this Personal Data Processing Policy
                                        (the "Policy"), the following terms, definitions, and
                                        abbreviations are used:<br />
                                        ...
                                        for storing or recording personal data in electronic or written form
                                        (including paper documents and machine-readable media).<br />
                                        Non-automated processing of personal data - personal data
                                        processing performed without automated tools, where all actions (e.g., use,
                                        updating, distribution, deletion) are carried out manually for each
                                        subject.<br />
                                        Anonymization of personal data - actions that make it impossible
                                        to identify a personal data subject without the use
                                        of additional information.<br />
                                        Processing of personal data - any operation or series
                                        of operations performed on personal data, with or
                                        without automated tools, including collection, recording, systematization,
                                        accumulation, storage, updating (modification), retrieval, use, transfer
                                        (distribution, provision, access), anonymization, blocking, deletion, and
                                        destruction.<br />
                                        Organization - independently or jointly with others
                                        organizes and/or performs personal data processing, defines processing purposes,
                                        determines the scope of data to be processed, and performs (or
                                        arranges) the required operations.<br />
                                        Personal data - any information processed
                                        by the Organization, including information submitted through its
                                        official website BST Developers and/or collected during the use
                                        of the website, relating directly or indirectly
                                        to a specific or identifiable natural person (the data
                                        subject).<br />
                                        The Organization processes the following categories of personal
                                        data:<br />
                                        Data voluntarily submitted by the data subject via input forms (e.g.,
                                        full name, email address, phone number);<br />
                                        Data contained in messages sent by the data subject
                                        to the Organization;<br />
                                        Data necessary for the conclusion and performance of contracts,
                                        fulfillment of legal obligations, or protection
                                        of the Organization's legitimate interests;<br />
                                        Statistical and technical data (e.g., user settings, identifiers, cookies),
                                        including data obtained through third-party analytics tools;
                                        the Organization does not combine personally identifiable information
                                        with passively collected data.<br />
                                        Policy - this Personal Data Processing Policy
                                        of Organization<br />
                                        Disclosure of personal data - intentional or accidental
                                        violation of confidentiality requirements by personnel or third
                                        parties with unauthorized access.<br />
                                        Dissemination of personal data - actions aimed
                                        at transferring personal data to an undefined number
                                        of persons.<br />
                                        Website - the Organization's official website
                                        at BST Developers<br />
                                        Data subject - a natural person whose personal data is processed
                                        by the Organization, including:</p>

                                    <ul>
                                        <li>Organization personnel,</li>
                                        <li>Clients or contractual counterparties,</li>
                                        <li>Other individuals, such as:</li>
                                        <li>legal representatives,</li>
                                        <li>beneficiaries of contracts,</li>
                                        <li>directors, shareholders, and representatives of counterparties,</li>
                                        <li>individuals subject to regulatory disclosure requirements,</li>
                                        <li>users accessing or interacting with the Organization's
                                            website or services.</li>
                                    </ul>

                                    <p>Cross-border transfer of personal data - transmission
                                        of personal data to foreign jurisdictions or foreign
                                        individuals/entities.<br />
                                        Destruction of personal data - actions that make it impossible
                                        to restore personal data in the information system and/or result
                                        in the destruction of physical storage media.<br />
                                        Cookies - a set of depersonalized data stored
                                        in a user's browser and processed
                                        by the Organization's web resource during website
                                        usage.<br />
                                        2. General Provisions<br />
                                        This Policy outlines the basic principles, objectives, conditions, and
                                        methods of personal data processing carried
                                        out by the Organization.<br />
                                        The Policy is developed in accordance with applicable data
                                        protection legislation and internal regulations on information security and
                                        data protection.<br />
                                        The Policy applies to all personal data processed
                                        by the Organization, regardless of format, method
                                        of transmission, or storage. In resolving matters related
                                        to personal data processing, the Organization prioritizes compliance
                                        with applicable law over internal regulations. In the event
                                        of any inconsistency between this Policy and applicable data
                                        protection requirements, the Organization adheres
                                        to the requirements of the law until internal documents
                                        are updated.<br />
                                        For any matters not expressly covered by this Policy or internal
                                        regulations, the Organization refers to applicable data protection
                                        laws, regulatory guidance, and relevant international standards.<br />
                                        This Policy is a publicly available internal document
                                        of the Organization and is published online at BST Developers<br />
                                        The Organization may update this Policy periodically. The new version
                                        becomes effective upon publication on the website unless stated
                                        otherwise. Continued use of the website or ongoing interaction
                                        with the Organization signifies acceptance of the updated
                                        Policy.onal data processing performed without automated tools, where all
                                        actions (e.g., use, updating, distribution, deletion) are carried
                                        out manually for each subject.<br />
                                        Anonymization of personal data - actions that make it impossible
                                        to identify a personal data subject without the use
                                        of additional information.<br />
                                        Processing of personal data - any operation or series
                                                            ...
                                                            <form
                                                                ...
                                                                <div class="col col--xs-4 col--md-6 l-callback__form">
                                                                    ...
                                                                    <div class="sr-only" data-plugin="inputBear ">
                                                                        <label for="text-381831"
                                                                            class="form-label text-c1 text-color-small leading-trim">
                                                                            Message </label>
                                                                        <input id="text-381831" name="message"
                                                                    ...
                                                                    <div class="l-callback__group">
                                                                        <div class="col col--md-12 mb-2 mb-1:md">
                                                                            <div class="form-control form-control--input form-control--float"
                                                                                ...
                                                                                <input id="text-50484" name="name"
                                                                                    type="text" required
                                                                                    placeholder="Name" maxlength="50"
                                                                                    value="">
                                                                                <label for="text-50484"
                                                                        ...
                                                                        <div class="col col--md-12">
                                                                            <div class="form-control form-control--input form-control--float"
                                                                                data-plugin="inputState">
                                                                                <input id="text-513812" name="message"
                                                                                    type="text" required
                                                                                    placeholder="Message"
                                                                                    maxlength="500" value="">
                                                                                <label for="text-513812"
                                                                                    class="form-label text-c1 text-color-small ">
                                                                                    Message </label>
                                                                                <svg class="icon icon-form-success form-control__success"
                                                                                    width="20" height="20"
                                                            ...
                                                            <form
                                                                ...
                                                                <div class="col col--xs-4 col--md-6 l-callback__form">
                                                                    ...
                                                                    <input data-plugin="pagePathname" type="hidden"
                                                                        name="currentPageLink" value="">
                                                                    <div class="sr-only" data-plugin="inputBear ">
                                                                        <label for="text-944359"
                                                                            class="form-label text-c1 text-color-small leading-trim">
                                                                            Message </label>
                                                                        <input id="text-944359" name="message"
                                                                            type="text" required value="">
                                                                    </div>
                                                                    <div class="l-callback__group">
                                                                        <div class="col col--md-12 mb-2 mb-1:md">
                                                                            <div class="form-control form-control--input form-control--float"
                                                                                data-plugin="inputState">
                                                                                <input id="text-795270" name="name"
                                                                                    type="text" required
                                                                                    placeholder="Name" maxlength="50"
                                                                                    value="">
                                                                                <label for="text-795270"
                                                                                    class="form-label text-c1 text-color-small ">
                                                                                    Name </label>
                                                                                <svg class="icon icon-form-success form-control__success"
                                                                                    width="20" height="20"
                                                                        ...
                                                                        <div class="form-group group mb-2 mb-1:md">
                                                                            <div class="col">
                                                                                <div class="form-control form-control--input form-control--float"
                                                                                    data-plugin="inputState inputMask"
                                                                                    data-input-mask-mask="+# ### ### ## ##">
                                                                                    <input id="text-893476" name="phone"
                                                                                        type="tel" required
                                                                                        placeholder="Phone"
                                                                                        maxlength="20"
                                                                                        autocapitalize="none" value="">
                                                                                    <label for="text-893476"
                                                                                        class="form-label text-c1 text-color-small ">
                                                                                        Phone </label>
                                                                                    <svg class="icon icon-form-success form-control__success"
                                                                                        width="20" height="20"
                                            ...
                                            <form class="flats-subscribe__form-container pt-2:md" method="POST"
                                                ...
                                                <div class="col col--xs-4 col--md-6 flats-subscribe__form">
                                                    ...
                                                    <div class="sr-only" data-plugin="inputBear ">
                                                        ...
                                                        <label for="text-786532"
                                                            class="form-label text-c1 text-color-small leading-trim">
                                                            Message </label>

                                                        <input id="text-786532" name="message" type="text" required
                                                            value="">
                                                    </div>
    ...
    " data-plugin="inputState  ">
                                                                ...
                                                                <input id="text-138934" name="email" type="email"
                                                                    required placeholder="e-mail" maxlength="50"
                                                                    autocapitalize="none" value="">



                                                                <label for="text-138934"
                                                                    class="form-label text-c1 text-color-small ">
                                                                    e-mail </label>
                                            ...
                                            <form class="flats-subscribe__form-container pt-2:md" method="POST"
                                                ...
                                                <div class="col col--xs-4 col--md-6 flats-subscribe__form">
                                                    ...
                                                    <div class="sr-only" data-plugin="inputBear ">
                                                        ...
                                                        <label for="text-391380"
                                                            class="form-label text-c1 text-color-small leading-trim">
                                                            Message </label>

                                                        <input id="text-391380" name="message" type="text" required
                                                            value="">
                                                    </div>
    ...
    " data-plugin="inputState  ">
                                                                ...
                                                                <input id="text-525934" name="email" type="email"
                                                                    required placeholder="e-mail" maxlength="50"
                                                                    autocapitalize="none" value="">



                                                                <label for="text-525934"
                                                                    class="form-label text-c1 text-color-small ">
                                                                    e-mail </label>
                                            ...
                                            <form class="flats-subscribe__form-container pt-2:md" method="POST"
                                                ...
                                                <div class="col col--xs-4 col--md-6 flats-subscribe__form">
                                                    ...
                                                    <input data-plugin="pagePathname" type="hidden"
                                                        name="currentPageLink" value="">
                                                    <div class="sr-only" data-plugin="inputBear ">
                                                        <label for="text-578017"
                                                            class="form-label text-c1 text-color-small leading-trim">
                                                            Message </label>
                                                        <input id="text-578017" name="message" type="text" required
                                                            value="">
                                                    </div>
    ...
    " data-plugin="inputState  ">
                                                                ...
                                                                <input id="text-256038" name="email" type="email"
                                                                    required placeholder="e-mail" maxlength="50"
                                                                    autocapitalize="none" value="">



                                                                <label for="text-256038"
                                                                    class="form-label text-c1 text-color-small ">
                                                                    e-mail </label>
                                            ...
                                            <form class="flats-subscribe__form-container pt-2:md" method="POST"
                                                ...
                                                <div class="col col--xs-4 col--md-6 flats-subscribe__form">
                                                    ...
                                                    <div class="sr-only" data-plugin="inputBear ">
                                                        ...
                                                        <label for="text-54122"
                                                            class="form-label text-c1 text-color-small leading-trim">
                                                            Message </label>

                                                        <input id="text-54122" name="message" type="text" required
                                                            value="">
                                                    </div>
    ...
    " data-plugin="inputState  ">
                                                                ...
                                                                <input id="text-538166" name="email" type="email"
                                                                    required placeholder="e-mail" maxlength="50"
                                                                    autocapitalize="none" value="">



                                                                <label for="text-538166"
                                                                    class="form-label text-c1 text-color-small ">
                                                                    e-mail </label>
                                            ...
                                            <div class="header__content px-layout">
                                                <div class="header__left header-animation-logo is-hidden--md-up">
                                                    <a class="header__logo--mobile" href="index.html"
                                                        aria-label="Homepage">
                                                        <img class="icon icon-logo-mobile" width="82" height="30"
                                                            aria-hidden="true" src="assets/images/bst-new-logo.png" />
                                                    </a>
                                                </div>
    ...
    <script src="assets/javascripts/privacy-policy.js"></script>
</body>
