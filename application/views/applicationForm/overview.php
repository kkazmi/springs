                                   ...
                                   <div class="col col--md-5">
                                    ...
                                    <div class="col col--md-5">
                                        ...
                                        <div style="display: flex; gap: 10px; align-items: center;">
                                            <input type="text" id="pan_1" name="pan_1" style="width: 120px; flex: none;">
                                            <input type="file">
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col col--md-5">
                                        ...
                                        <div style="display: flex; gap: 10px; align-items: center;">
                                            <input type="text" id="aadhar_1" name="aadhar_1" style="width: 120px; flex: none;">
                                            <input type="file">
                                        </div>
                                        </div>
                                    </div>
                                   ...
                                   <div class="col col--md-5">
                                    ...
                                    <div class="col col--md-5">
                                        ...
                                        <div style="display: flex; gap: 10px; align-items: center;">
                                            ...
                                            <input type="text" id="pan_2" name="pan_2" style="width: 35%; flex: none;">
                                            <label for="aadhar_2" style="width: auto; margin-left: 5px;">Aadhar No.</label>
                                            <input type="text" id="aadhar_2" name="aadhar_2" style="width: 35%; flex: none;">
                                        </div>
                                        </div>
                                    </div>
