...
<head>
    ...
    <title>BST Developers | Design and architecture of BST Developers residential complex</title>
    <style>
        body {
            background: #F5E8D1;
            color: #F5E8D1;
...
<body data-barba="wrapper">
    ...
    <div class="
        ...
        js-preloader            " data-plugin="preloader" data-preloader-visible="true">
                                        ...
                                        <div class="col col--md-6 ui-dark ui-background px-layout py-layout pt-1:md pb-2:md"
                                            ...
                                            <div class="" data-plugin="parallax" data-parallax-enable-mq="md-up"
                                                ...
                                                <h3 class="h3 leading-trim" data-reveal="text">
                                                    ...
                                                    towards&nbsp;the&nbsp;sky. Wave-like&nbsp;longlines wrap
                                                        ...
                                                        <span class="header__logo__inner header-animation-logo">
                                                            <span class="header__logo__left">
                                                                <img class="icon icon-logo-left" width="122" height="55"
                                                                    aria-hidden="true" src="assets/images/logoIcon.png"/>
                                                            </span>
                                                            <span class="header__logo__right">
                                                                <img class="icon icon-logo-right" width="29" height="55"
                                                                    aria-hidden="true" src="assets/images/logoText.png"/>
                                                            </span>
                                                        </span>
                                                    </a>
                                                </div>
